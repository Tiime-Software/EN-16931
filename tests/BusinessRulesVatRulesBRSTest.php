...
class BusinessRulesVatRulesBRSTest extends TestCase
{
     ...
     * registration identifier (BT-32) and/or the Seller tax representative VAT identifier (BT-63).
     * @dataProvider provideBrS4Success
     */
    public function brS4_success(Seller $seller, ?SellerTaxRepresentativeParty $sellerTaxRepresentativeParty): void
    {
        $invoice = new Invoice(
            new InvoiceIdentifier('34'),
            new \DateTimeImmutable(),
    ...
    public static function provideBrS4Success(): \Generator
    {
        yield 'BR-S-3 - Only Seller VatIdentifier field' => [
            'seller' => new Seller(
                'John Doe',
     ...
     * registration identifier (BT-32) and/or the Seller tax representative VAT identifier (BT-63).
     */
    public function brS4_error(): void
    {
        $this->markTestSkipped('Same error case as BR-S-2 that\'s why BR-S-2 exception is thrown before BR-S-4 exception');
    }
     ...
     */
    public function brS10_success(?string $reasonText, ?VatExemptionReasonCode $reasonCode): void
    {
     ...
     */
    public function brS10_error(?string $reasonText, ?VatExemptionReasonCode $reasonCode): void
    {
        $this->expectException(\Exception::class);
