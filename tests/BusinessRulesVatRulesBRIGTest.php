...
class BusinessRulesVatRulesBRIGTest extends TestCase
{
    ...
    /**
     * @test
     * @testdox BR-IG-2 : An Invoice that contains an Invoice line (BG-25) where the Invoiced item VAT category code
     * (BT-151) is “IGIC” shall contain the Seller VAT Identifier (BT-31), the Seller tax registration identifier
     * (BT-32) and/or the Seller tax representative VAT identifier (BT-63).
     * @dataProvider provideBrIG2Success
     */
    public function brIG2_success(Seller $seller, ?SellerTaxRepresentativeParty $sellerTaxRepresentativeParty): void
    {
        $invoice = new Invoice(
            new InvoiceIdentifier('34'),
            new \DateTimeImmutable(),
    ...
    public static function provideBrIG2Success(): \Generator
    {
        yield 'BR-IG-2 - Only Seller VatIdentifier field' => [
            'seller' => new Seller(
                'John Doe',
                new SellerPostalAddress(CountryAlpha2Code::FRANCE),
                [new SellerIdentifier('10000000900017', InternationalCodeDesignator::SIRET_CODE)],
        ...
        yield 'BR-IG-2 - Only Seller TaxRegistrationIdentifier field' => [
            'seller' => new Seller(
                'John Doe',
                new SellerPostalAddress(CountryAlpha2Code::FRANCE),
                [new SellerIdentifier('10000000900017', InternationalCodeDesignator::SIRET_CODE)],
        ...
        yield 'BR-IG-2 - Only SellerTaxRepresentativeParty field' => [
            'seller' => new Seller(
                'John Doe',
                new SellerPostalAddress(CountryAlpha2Code::FRANCE),
                [new SellerIdentifier('10000000900017', InternationalCodeDesignator::SIRET_CODE)],
        ...
        yield 'BR-IG-2 - Seller VatIdentifier and Seller TaxRegistrationIdentifier fields' => [
            'seller' => new Seller(
                'John Doe',
                new SellerPostalAddress(CountryAlpha2Code::FRANCE),
                [new SellerIdentifier('10000000900017', InternationalCodeDesignator::SIRET_CODE)],
        ...
        yield 'BR-IG-2 - Seller VatIdentifier and SellerTaxRepresentativeParty fields' => [
            'seller' => new Seller(
                'John Doe',
                new SellerPostalAddress(CountryAlpha2Code::FRANCE),
                [new SellerIdentifier('10000000900017', InternationalCodeDesignator::SIRET_CODE)],
        ...
        yield 'BR-IG-2 - Seller TaxRegistrationIdentifier and SellerTaxRepresentativeParty fields' => [
            'seller' => new Seller(
                'John Doe',
                new SellerPostalAddress(CountryAlpha2Code::FRANCE),
                [new SellerIdentifier('10000000900017', InternationalCodeDesignator::SIRET_CODE)],
        ...
        yield 'BR-IG-2 - Seller VatIdentifier and Seller TaxRegistrationIdentifier and SellerTaxRepresentativeParty fields' => [
            'seller' => new Seller(
                'John Doe',
                new SellerPostalAddress(CountryAlpha2Code::FRANCE),
                [new SellerIdentifier('10000000900017', InternationalCodeDesignator::SIRET_CODE)],
     ...
     * (BT-32) and/or the Seller tax representative VAT identifier (BT-63).
     */
    public function brIG2_error(): void
    {
        $this->expectException(\Exception::class);
    ...
    /**
     * @test
     * @testdox BR-IG-3 : An Invoice that contains a Document level allowance (BG-20) where the Document level allowance
     * VAT category code (BT-95) is “IGIC” shall contain the Seller VAT Identifier (BT31), the Seller tax registration
     * identifier (BT-32) and/or the Seller tax representative VAT identifier (BT-63).
     * @dataProvider provideBrIG3Success
     */
    public function brIG3_success(Seller $seller, ?SellerTaxRepresentativeParty $sellerTaxRepresentativeParty): void
    {
        $invoice = new Invoice(
            new InvoiceIdentifier('34'),
            new \DateTimeImmutable(),
    ...
    public static function provideBrIG3Success(): \Generator
    {
        yield 'BR-IG-2 - Only Seller VatIdentifier field' => [
            'seller' => new Seller(
                'John Doe',
     ...
     * identifier (BT-32) and/or the Seller tax representative VAT identifier (BT-63).
     */
    public function brIG3_error(): void
    {
        $this->markTestSkipped('Same error case as BR-IG-2 that\'s why BR-IG-2 exception is thrown before BR-IG-3 exception');
    }
